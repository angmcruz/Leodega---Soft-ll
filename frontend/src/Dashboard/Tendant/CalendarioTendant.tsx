    ...
    const DayView = () => {
        ...
        return (
            <div className="border border-gray-200 rounded-lg overflow-hidden h-full flex flex-col">
                <div className="bg-gray-50 p-3 border-b border-gray-200 text-center shrink-0">
                ...
                <div className="overflow-y-auto flex-1">
                    {hours.map(hour => (
                        <div key={hour} className="flex border-b border-gray-100">
                            <div className="w-20 p-2 text-xs text-gray-500 text-right shrink-0">
                ...
                <div className="overflow-y-auto flex-1">
                    {hours.map(hour => (
                        <div key={hour} className="grid grid-cols-8 border-b border-gray-100">
                            <div className="p-2 text-xs text-gray-500 text-right shrink-0">
                                {hour.toString().padStart(2, '0')}:00
                            </div>
                            {weekDays.map((day, idx) => (
                            ...
                            <div className="flex gap-2">
                                {[
                                    ...
                                    <button 
                                        ...
                                        className={`px-4 py-2 text-sm rounded-md capitalize ${view === v.value ? 'bg-blue-500 text-white' : 'hover:bg-gray-50'}`}>
                                        {v.label}
                                    </button>
                                ))}
                            </div>
