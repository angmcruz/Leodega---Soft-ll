...
import { Search, MoreVertical, Paperclip, Send, Star, Trash2, Inbox, Mail, PenTool, Menu, X } from 'lucide-react';
import HeaderTendant from '../../Components/HeaderTendant';

type Categoria = 'inbox' | 'enviados' | 'redactar' | 'importante' | 'eliminados';

const MensajesTendant: React.FC = () => {
...
export default MensajesTendant;